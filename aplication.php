	...
	<div class="wrapper">
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
			...
			//Pengguna
			  case 'data-tagihan-lunas':
				  include "penghuni/data_tagihan_lunas.php";
				  break;
			//Pengguna
			  case 'tagihan-belum-lunas':
				  include "penghuni/tagihan_belum_lunas.php";
				  break;
			
			//Pengguna
			 case 'tagihan':
				  include "penghuni/tagihan.php";
				  break;
